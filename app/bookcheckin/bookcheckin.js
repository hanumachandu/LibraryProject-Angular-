...
angular.module('myApp.bookcheckin', ['ui.router'])

.config(['$stateProvider', function($stateProvider) {
    $stateProvider.state('/home.bookcheckin', {
        url:'/bookcheckin',
       
                templateUrl: 'bookcheckin/bookcheckin.html',
                controller: 'bookcheckinCtrl'
  });
}])


.controller('bookcheckinCtrl', ['$scope','$rootScope', 'MetaService','USERSERVICE','$location', '$http', function($scope, $rootScope, MetaService, USERSERVICE, $location, $http) {
